            ...
            IntroForm(
                ...
                Section(LocalizedStringResource("Core Features")) {
                    VStack(alignment: .leading) {
                        ...
                        FeatureFlagToggle(
                            title: String(localized: LocalizedStringResource("Enable Software Updates")),
                            description: String(
                                localized: LocalizedStringResource(
                                    "Show/hide the Software Updates feature in settings."
                                )
                            ),
                            isEnabled: viewModel.featureFlags.enableSoftwareUpdates,
                            onToggle: viewModel.setEnableSoftwareUpdates
                        )
                ...
                Section(LocalizedStringResource("Licensing")) {
                    VStack(alignment: .leading) {
                        ...
                        if viewModel.enableLicensing {
                            FeatureFlagToggle(
                                title: String(localized: LocalizedStringResource("Enable Trial Request")),
                                description: String(
                                    localized: LocalizedStringResource(
                                        "Show/hide the ability to request trial licenses."
                                    )
                                ),
                                isEnabled: viewModel.enableTrialRequest,
                                onToggle: viewModel.setEnableTrialRequest
                            )
