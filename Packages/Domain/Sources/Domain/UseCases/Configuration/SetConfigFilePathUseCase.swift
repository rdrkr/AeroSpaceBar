...
/// Use case for setting the configuration file path.
///
/// This use case encapsulates the business logic for setting the configuration file path.
...
@MainActor
public final class SetConfigFilePathUseCase {
    ...
    /// Executes the use case to set the configuration file path.
    /// - Parameter value: The configuration file path
    public func execute(value: String) async {
        await configurationGateway.setConfigFilePath(value)
    }
}
