...
/// Use case for retrieving spaces effect properties.
///
...
@MainActor
public final class GetSpacesEffectPropertiesUseCase {
    /// The configuration gateway for accessing spaces effect properties data.
    ...
    /// Executes the use case to get the spaces effect properties.
    /// - Returns: A publisher that emits the current spaces effect properties
    public func execute() -> AnyPublisher<[EffectProperties], Never> {
        configurationGateway.spacesEffectPropertiesPublisher
    }
}
