...
enum Logger {
    ...
    static let app = OSLog(subsystem: "com.rdrkr.AeroSpaceBar", category: "app")

    /// Log category for AeroSpace CLI operations.
    static let aerospace = OSLog(subsystem: "com.rdrkr.AeroSpaceBar", category: "aerospace")

    /// Log category for spaces and windows management.
    static let spaces = OSLog(subsystem: "com.rdrkr.AeroSpaceBar", category: "spaces")

    /// Log category for configuration and settings.
    static let config = OSLog(subsystem: "com.rdrkr.AeroSpaceBar", category: "config")

    /// Log category for UI and presentation layer.
    static let userInterface = OSLog(subsystem: "com.rdrkr.AeroSpaceBar", category: "ui")

    /// Log category for data layer operations.
    static let data = OSLog(subsystem: "com.rdrkr.AeroSpaceBar", category: "data")

    /// Log category for performance metrics.
    static let performance = OSLog(subsystem: "com.rdrkr.AeroSpaceBar", category: "performance")
    ...
    enum SignpostID {
        static let spacesFetch = signposter.makeSignpostID()
        static let windowFocus = signposter.makeSignpostID()
        static let spaceFocus = signposter.makeSignpostID()
        static let iconLoad = signposter.makeSignpostID()
        static let wallpaperLoad = signposter.makeSignpostID()
        static let cliOperation = signposter.makeSignpostID()
    }
    ...
    static func measure<T>(_ name: String, id _: OSSignpostID, operation: @Sendable () throws -> T) rethrows -> T {
